...
describe('statement', () => {
  it('throw Error();', () => {
    const result = [
      { type: 'Identifier', value: 'throw', start: 0, end: 5 },
      { type: 'Identifier', value: 'Error', start: 6, end: 11 },
      { type: 'LeftParen', value: '(', start: 11, end: 12 },
      { type: 'RightParen', value: ')', start: 12, end: 13 },
  ...
  it('{}', () => {
    const result = [
      { type: 'LeftCurly', value: '{', start: 0, end: 1 },
      { type: 'RightCurly', value: '}', start: 1, end: 2 },
    ]
    const code = '{}'
    expect(tokenize(code)).toEqual(result)
  })
  it('try {} catch(e) {} finally{}', () => {
    const result = [
      { type: 'Identifier', value: 'try', start: 0, end: 3 },
      { type: 'LeftCurly', value: '{', start: 4, end: 5 },
      { type: 'RightCurly', value: '}', start: 5, end: 6 },
      { type: 'Identifier', value: 'catch', start: 7, end: 12 },
      { type: 'LeftParen', value: '(', start: 12, end: 13 },
      { type: 'Identifier', value: 'e', start: 13, end: 14 },
      { type: 'RightParen', value: ')', start: 14, end: 15 },
      { type: 'LeftCurly', value: '{', start: 16, end: 17 },
      { type: 'RightCurly', value: '}', start: 17, end: 18 },
      { type: 'Identifier', value: 'finally', start: 19, end: 26 },
      { type: 'LeftCurly', value: '{', start: 26, end: 27 },
      { type: 'RightCurly', value: '}', start: 27, end: 28 },
    ]
